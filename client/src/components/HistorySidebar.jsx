...
export default function HistorySidebar({ isOpen, onToggle }) {
  ...
  const PageIcon = pageIcons[pageType] || Folder;
        ...
        <div className="p-4 border-b border-gray-800 bg-gray-900/80">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-gray-800/70 border border-gray-700 flex items-center justify-center">
                <PageIcon className="w-4 h-4 text-gray-200" />
              </div>
              <div>
            ...
            {allowClear && (
              <button
                ...
                className="text-xs px-2.5 py-1.5 rounded-lg bg-gray-800/80 border border-gray-700 text-gray-300 hover:text-white hover:border-gray-600 transition-colors flex items-center gap-1.5"
              >
        ...
        <div className="p-3 border-b border-gray-800">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-800/70 border border-gray-700 rounded-lg pl-9 pr-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-purple-500/40"
              ...
              {filteredIds.map((id) => {
                ...
                return (
                  <button
                    ...
                    className="group text-left bg-gray-900/60 hover:bg-gray-800/80 border border-gray-800 hover:border-gray-700 rounded-xl p-3 transition-all"
                  >
                    <div className="flex items-start gap-3">
                      <div className="mt-0.5 w-8 h-8 rounded-lg bg-gray-800/70 border border-gray-700 flex items-center justify-center text-gray-300">
                      ...
                      <span
                        ...
                        className="ml-auto inline-flex items-center justify-center w-7 h-7 rounded-lg bg-gray-800/70 border border-gray-700 text-gray-300 hover:text-rose-200 hover:border-rose-500/40 hover:bg-rose-500/10 transition-colors"
                        title="Delete"
                      >
                        <Trash2 className="w-3.5 h-3.5" />
                      </span>
