...
export default function VideoGenerator() {
  ...
  const activeWanA14BSpaceUrl = toHuggingFaceSpacePageUrl(PUBLIC_WAN_I2V_A14B_SPACE_ID);
                      ...
                      <div className="space-y-2">
                        {wanImageData ? (
                          <div className="relative rounded-lg overflow-hidden bg-gray-900 border border-gray-700">
                            ...
                            />
                            {wanImageSourceType === "video" && (
                              <div className="absolute top-1.5 left-1.5 bg-gray-900/70 text-[10px] text-purple-300 px-1.5 py-0.5 rounded flex items-center gap-1">
