    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-gray-900 border border-gray-800 rounded-xl p-4 space-y-3">
        ...
        <p className="text-xs text-gray-400">
          This exports a JSON manifest (no rendering). Use a renderer to produce
          MP4/WebM.
        </p>
        <select
          value={format}
        ...
        />
        <p className="text-xs text-gray-400">
          Preset support includes 4K/60fps (`3840x2160`, `60`).
        </p>
        <div className="flex gap-2 justify-end">
          <button className="px-3 py-2 rounded bg-gray-700" onClick={onClose}>
            Cancel
          </button>
          <button
